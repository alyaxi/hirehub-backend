...
const {  updateJobStatusValidator, deleteJobValidator, validateAppliedJob, validateJobPosting } = require("../../utilis/BodyValidator");
...
router.post("/add-jobs-by-employer", authMiddleware, checkRole(['employer']), validateJobPosting, addJobByEmployer)
